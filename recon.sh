...
show_banner() {
    ...
    echo -e "${CYAN}"
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║          BUG BOUNTY RECON PIPELINE v1.0 (Shakibul)          ║"
...
check_tools() {
    ...
    if [ ${#missing_required[@]} -gt 0 ]; then
        ...
        echo -e "\n${YELLOW}[*]${NC} Please run: ${BLUE}bash install.sh${NC}"
        exit 1
    fi
...
EOF
    ...
    cat >> "$reports_dir/report.html" <<EOF
        ...
        <div class="footer">
            <p>Generated by Bug Bounty Recon Pipeline v1.0 (Enhanced)</p>
...
show_domain_summary() {
    ...
    echo -e "${PURPLE}[+]${NC} Created by: Shakibul (Shakibul_Cybersec) - Enhanced v1.0${NC}"
}

configure_scan() {
    echo -e "${CYAN}[*]${NC} Configuration"
    echo -e "${YELLOW}────────────────────────────────────────────────────${NC}"
    echo -e "${PURPLE}[i]${NC} Script by: Shakibul (Shakibul_Cybersec) - Enhanced v1.0${NC}"
    echo -e "${YELLOW}────────────────────────────────────────────────────${NC}"
...
main() {
    ...
    echo -e "${GREEN}══════════════════════════════════════════════════════════════${NC}"
    echo -e "${CYAN}Happy Hunting! 🚀 (Enhanced v1.0 by Shakibul)${NC}"
}
